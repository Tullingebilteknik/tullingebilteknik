...
import { LayoutDashboard, Wrench, FileText, Users, LogOut, ArrowLeft, CalendarDays, BarChart3 } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/schema", label: "Schema", icon: CalendarDays },
  { href: "/admin/leads", label: "Leads", icon: Users },
  { href: "/admin/leads/statistik", label: "Statistik", icon: BarChart3 },
